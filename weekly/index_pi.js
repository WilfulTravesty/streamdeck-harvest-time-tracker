...
function connectElgatoStreamDeckSocket(inPort, inPropertyInspectorUUID, inRegisterEvent, _inInfo, inActionInfo) {
    ...
    websocket.onmessage = function (evt) {
        try {
            ...
            console.log("pi/weekly received event " + event)

            switch (event) {
                case "didReceiveGlobalSettings":
                    globalSettings = jsonObj['payload']['settings']
                    console.log("pi/weekly received global settings: " + JSON.stringify(globalSettings))
                    break
                ...
                case "didReceiveSettings":
                    ...
                    console.log("pi/weekly has settings: " + JSON.stringify(settings));
                    setButtonSettings();
                ...
                case 'titleParametersDidChange':
                    console.log("pi/weekly title changed")
                    break
...
function update() {
    console.log("pi/weekly called update()");
    getWeeklyTotal()
        .then(ok => {
